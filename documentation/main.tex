...
\renewcommand{\author}{Robert Annessi}
\renewcommand{\title}{Building an auditory and visual stimulation device with EEG feedback loop}
\newcommand{\subject}{An open source software and hardware approach for controllable brainwave entrainment}
